...
class AppLocalizationsPl extends AppLocalizations {
  ...
  String reportedBy(String username) {
    return 'Zgłoszony przez $username';
  }

  @override
  String reportedAt(String timeAgo) {
    return 'Zgłoszony $timeAgo';
  }
  ...
  String bearingToObject(int bearing) {
    return 'Nakładanie na obiekt: $bearing°';
  }
  ...
  String pushBodyAlertNearby(String distance) {
    return 'Zgłoszono nowe spostrzeżenie $distance away.';
  }
  ...
  String cloudCover(int percent) {
    return 'Pokrywa chmurowa: $percent%';
  }

  @override
  String wind(num speed, String unit) {
    return 'Wiatr: $speed $unit';
  }
  ...
  String quietHoursScheduled(Object end, Object start) {
    return 'Godziny ciszy: $start - $end';
  }
  ...
  String pushNotificationCommented(Object username) {
    return '$username skomentowane';
  }

  @override
  String pushNotificationCommentedOn(Object beepTitle, Object username) {
    return '$username skomentował $beepTitle';
  }
  ...
  String mufonCaseDetailsTitle(String caseNumber) {
    return 'Przypadek MUFON #$caseNumber Szczegóły';
  }
  ...
  String witnessesCountMessage(int count) {
    return '$count ludzie potwierdzili to spostrzeżenie';
  }
  ...
  String mediaItemsProcessed(int count) {
    return 'Analiza: $count media plik (y) przetworzony (y)';
  }
  ...
  @override
  String get attachMedia => 'Dołącz media';

  @override
  String get addCommentOptional => 'Dodaj komentarz (opcjonalnie)';

  @override
  String get describeNewMedia => 'Opisz nowe media...';

  @override
  String get filesSelected => 'zaznaczone pliki';

  @override
  String get selectMediaToAttach =>
      'Proszę wybrać zdjęcia lub filmy, aby dołączyć';

  @override
  String get newMediaUploaded => 'Nowe media';

  @override
  String get mediaFilesUploaded => 'nowe pliki multimedialne przesłane';

  @override
  String get filesAttachedSuccessfully => 'pliki dołączone pomyślnie';
  ...
  @override
  String get formalReporting => 'Formalna sprawozdawczość';
  ...
  String mufonCaseTitle(String caseNumber) {
    return 'MUFON Sprawa #$caseNumber';
  }
  ...
  String mufonTitleFormat(Object classification) {
    return 'MUFON $classification Raport';
  }
  ...
  String signInWelcome(String username) {
    return 'Powitanie $username!';
  }

  @override
  String signInFailed(String error) {
    return 'Sygnał nie powiódł się: $error';
  }
  ...
  String signInTryAgainIn(int seconds) {
    return 'Spróbuj ponownie w ${seconds}s';
  }
  ...
  String phoneAuthPhoneVerified(String phoneNumber) {
    return 'Numer telefonu zweryfikowany: $phoneNumber';
  }
  ...
  String phoneAuthEnterSixDigitCode(String phoneNumber) {
    return 'Wprowadź 6-cyfrowy kod wysłany do $phoneNumber';
  }
  ...
  String get onboardingWelcomeBody =>
      'Uzyskaj informacje o czasie rzeczywistym, gdy UFO jest w pobliżu. Nigdy więcej nie przegap widoku.';

  @override
  String get onboardingAlertsTitle => 'Zostań poinformowany';

  @override
  String get onboardingAlertsBody =>
      'Ustal, jak daleko powinny być obserwacje, aby wywołać ostrzeżenia.';
  ...
  String get onboardingReportBody =>
      'Snap zdjęcie lub wideo i udostępniać natychmiast z pobliskich obserwatorów.';

  @override
  String get onboardingPermissionsTitle => 'Twoja kamera i lokalizacja';

  @override
  String get onboardingPermissionsBody =>
      'Włącz kamerę, lokalizację i powiadomienia, dzięki czemu możesz:\n- Zgłoś to szybko.\n- Pobierz ostrzeżenia dla UFO w pobliżu';

  @override
  String get onboardingCameraTitle => 'Dowody przechwytywania';

  @override
  String get onboardingCameraBody =>
      'Udostępnij zdjęcia i filmy, które właśnie nagrałeś z galerii lub naciśnij ikonę UFOBeep, aby rozpocząć w trybie natychmiastowym.';
  ...
  @override
  String get onboardingCommunityTitle => 'Dołącz do obserwatorów';

  @override
  String get onboardingCommunityBody =>
      'Przeglądanie obserwacji, dostęp do raportów MUFON i połączenie z innymi obserwatorami.';
  ...
  String celestialMoonBright(Object phase) {
    return 'Jasny księżyc $phase widoczny - może oświetlić lub zasłonić inne obiekty';
  }

  @override
  String celestialMoonModerate(Object phase) {
    return 'Księżyc $phase widoczny - umiarkowane warunki oświetlenia';
  }

  @override
  String celestialMoonThin(Object phase) {
    return 'Cienki księżyc $phase widoczny - minimalne oświetlenie';
  }

  @override
  String celestialMoonHidden(Object phase) {
    return 'Księżyc $phase poniżej horyzontu - brak oświetlenia';
  }
  ...
  String celestialPlanetHigh(Object altitude, Object planet) {
    return '$planet wysoko nad głową ($altitude°) - bardzo widoczny';
  }

  @override
  String celestialPlanetMedium(Object altitude, Object planet) {
    return '$planet widoczny na $altitude° - może być mylony z samolotem';
  }

  @override
  String celestialPlanetLow(Object altitude, Object planet) {
    return '$planet nisko nad horyzontem ($altitude°)';
  }
  ...
  String celestialStarSingle(Object altitude, Object star) {
    return '$star widoczna na $altitude°';
  }

  @override
  String celestialStarsMultiple(Object count, Object names) {
    return '$count jasne gwiazdy widoczne - $names';
  }
  ...
  String celestialSummaryManyObjects(Object count) {
    return '$count jasne obiekty, które mogą być mylone z UFO';
  }

  @override
  String celestialSummarySomeObjects(Object count) {
    return '$count jasny (-e) obiekt (-y) widoczny (-e)';
  }
  ...
  String celestialSkySummary(Object conditions) {
    return 'Warunki dotyczące nieba: $conditions';
  }

  @override
  String get planetVenus => 'Wenus';

  @override
  String get planetJupiter => 'Jowisz';

  @override
  String get planetSaturn => 'Saturn Przewodniczący';

  @override
  String get planetMars => 'Mars';

  @override
  String get planetMercury => 'Rtęć';
  ...
  @override
  String get starSirius => 'Syriusz';

  @override
  String get starCanopus => 'Canopus';

  @override
  String get starArcturus => 'Arktur';
  ...
  @override
  String get moonPhaseNew => 'Nowy Księżyc';

  @override
  String get moonPhaseWaxingCrescent => 'Waking Crescent';

  @override
  String get moonPhaseFirstQuarter => 'Pierwszy kwartał';

  @override
  String get moonPhaseWaxingGibbous => 'Woskowanie Gibbous';

  @override
  String get moonPhaseFull => 'Full Moon';

  @override
  String get moonPhaseWaningGibbous => 'Wending Gibbous';

  @override
  String get moonPhaseThirdQuarter => 'Trzeci kwartał';
  ...
  String planetBelowHorizon(Object planet) {
    return '$planet poniżej horyzontu';
  }

  @override
  String planetHighOverheadProminent(Object altitude, Object planet) {
    return '$planet wysokie koszty ogólne ($altitude°) - bardzo znaczące';
  }

  @override
  String planetMidSkyProminent(Object altitude, Object planet) {
    return '$planet at $altitude° - wybitny';
  }
  ...
  String starVeryBright(Object altitude, Object star) {
    return '$star bardzo jasny na $altitude°';
  }
  ...
  @override
  String get launchedLabel => 'Wystrzelony';
  ...
  @override
  String get azimuthLabel => 'Azymut';

  @override
  String get visibilityLabel => 'Widoczność';

  @override
  String get satelliteType => 'Satelita';

  @override
  String get rocketBodyType => 'Korpus rakiety';

  @override
  String get debrisType => 'Odpady';

  @override
  String get nakedEyeVisible => 'Widoczny gołym okiem';

  @override
  String satellitesVisibleMightExplain(Object count) {
    return '$count satelity widoczne - może wyjaśnić widzenie';
  }

  @override
  String satellitesVisibleUnlikelyExplain(Object count) {
    return '$count satelitów widocznych - mało prawdopodobne aby wyjaśnić obserwację';
  }

  @override
  String get noSatellitesVisible => 'Brak widocznych satelitów';

  @override
  String aircraftDetectedInRadius(Object count, Object radius) {
    return '$count statek powietrzny wykryty w ${radius}km';
  }

  @override
  String get processingAlert => 'Przetwarzam alarm UFO...';

  @override
  String get analyzingEnvironment => 'Analiza warunków środowiskowych';

  @override
  String get weatherAnalysis => 'Analiza pogody';

  @override
  String get locationAnalysis => 'Analiza lokalizacji';

  @override
  String get aircraftTracking => 'Śledzenie statków powietrznych';

  @override
  String get satelliteAnalysis => 'Analiza satelitarna';

  @override
  String get celestialAnalysis => 'Analiza Niebiańska';

  @override
  String analyzing(Object processor) {
    return 'Analiza $processor...';
  }

  @override
  String get processorWeather => 'warunki pogodowe';

  @override
  String get processorLocation => 'szczegóły dotyczące lokalizacji';

  @override
  String get processorAircraft => 'pobliskie statki powietrzne';

  @override
  String get processorSatellites => 'pozycje satelitarne';
  ...
  String satellitesVisibleNow(int count) {
    return 'Satelity ($count widoczne teraz)';
  }
  ...
  String seeAllSatellites(int count) {
    return 'Zobacz wszystkie $count satelity';
  }

  @override
  String maxElevation(String degrees) {
    return 'Maksymalna wysokość: $degrees°';
  }

  @override
  String magnitude(String value) {
    return 'Wielkości: $value';
  }
  ...
  String translatedFrom(String language) {
    return 'Tłumaczone z $language';
  }

  @override
  String translateContent(String language) {
    return 'Przetłumacz zawartość na $language';
  }
  ...
  String aircraftDetectedCurrentPositions(int count, String radius) {
    return '$count samolotów wykrytych w promieniu ${radius}km (aktualne pozycje)';
  }

  @override
  String dimSatellitesUnlikely(int count) {
    return '$count dim satelity widoczne - mało prawdopodobne, aby wyjaśnić widzenie';
  }
