        ...
        filteredAlerts.forEach((alert) => {
          ...
          const popupContent = `
            <div class="text-sm">
              ...
              <div class="mt-2">
                <a class="text-blue-600 underline" href="/alerts/${getAlertSlug({ id: alert.id, title: alert.title || undefined, created_at: alert.created_at, location: { name: alert.location?.name } })}">View details →</a>
              </div>
            </div>
          `
