            ...
            content: `
              <div style="color: #333; padding: 10px; max-width: 240px; font-family: system-ui, -apple-system, sans-serif;">
                ...
                <div style="margin-top: 8px; padding-top: 8px; border-top: 1px solid #eee;">
                  <a href="/alerts/${nearby.id}/${getAlertSlug({ id: nearby.id, title: nearby.title, created_at: nearby.created_at, location: { name: nearby.location?.name } })}" style="background: #ff6b35; color: white; text-decoration: none; font-size: 12px; font-weight: 500; padding: 6px 12px; border-radius: 8px; display: inline-block;">
                    View Details →
                  </a>
                </div>
              </div>
